...
public class DoneProvider {
    ...
    public void create(Task task) throws SQLException {
        ...
        String sql =  "INSERT INTO A00358235DoneTasks(nombre,  descripcion,  fecha) VALUES ('$NOMBRE','$DESCRIPCION','$FECHA')";
    ...
    public ArrayList<Task> getAllTasks() throws SQLException {
        ...
        String sql = "SELECT * FROM A00358235DoneTasks";
        MySQLConnection connection = new MySQLConnection();
        connection.connect();
    ...
    public void deleteById(int id) throws SQLException {
        String sql = "DELETE FROM A00358235DoneTasks WHERE id ="+id;
        MySQLConnection connection =  new MySQLConnection();
        connection.connect();
        connection.commandSQL(sql);
        connection.disconnect();
